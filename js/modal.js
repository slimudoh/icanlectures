...
window.onclick = function() {
	...
	document.onclick = function(e) {
		if (e.target !== cartDiv || e.target !== userDiv ) {
			cartDiv.style.display = "none";
            		userDiv.style.display = "none";
		} //else if (e.target !== userDiv) {
            //userDiv.style.display = "none";
        //}
...
function validateFname() {
    var fnbd = document.getElementById("fn-bd");
     var fntxt = document.getElementById("fn-txt");

     if (fnbd.value === " ") {
       fnbd.value = "please enter a name";
     } else if (typeof fnbd.value  === "number") {
         fnbd.value = "please enter a name";
     }
}
