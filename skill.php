...
<html lang="en">
  <head>
    ...
    <title>ICANLECTURES.COM - Skilled Level</title>
        ...
        <div class="skill-banner">
          <div class="container">
            <div class="row">
              ...
              <div class="col-md-10">
                <h4 style="color:#fff">
                  <a href="index.php">HOME</a> <i class="fa fa-arrows-h"></i> SKILLED LEVEL
                </h4>
              </div>
            </div>
          </div>
              ...
              <div class="col-xs-12 col-sm-4 col-md-4 col-lg-2">
                <a href="#">
                  <div class="resource">
                    ...
                    <div class="res-top">
                      <h3>Public Sector Accounting and Finance</h3>
                    </div>
                    <div class="res-btm view">
                        VIEW
                    </div>
             ...
             <div class="col-xs-12 col-sm-4 col-md-4 col-lg-2">
                <a href="#">
                  <div class="resource">
                    ...
                    <div class="res-top">
                      <h3>Management, Governance and Ethics</h3>
                    </div>
                    <div class="res-btm view">
                        VIEW
                    </div>
