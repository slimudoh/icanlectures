...
<html lang="en">
  <head>
    ...
    <title>ICANLECTURES.COM - Basic Accounting Processes & System</title>
        ...
        <div class="detail-banner">
          <div class="container">
            <div class="row">
              ...
              <div class="col-md-10">
                <h4 style="color:#fff">
                  <a href="index.php">HOME</a> <i class="fa fa-arrows-h"></i> DOWNLOAD
                </h4>
              </div>
            </div>
          </div>
                ...
                <div class="row">
                  ...
                  <div class="col-xs-12 col-sm-6 col-md-6">
                    <div class="about-head">
                      <h3> BASIC ACCOUNTING PROCESSES & SYSTEM</h3>
                      <div class="rating">
                ...
                <div class="detail-sidebar">
                  ...
                  <div class="sidebar-box">
                    ...
                    <div class="sidebar-right">
                      ...
                      <br>
                      BASIC ACCOUNTING PROCESSES & SYSTEM
                    </div>
                  </div>
                    ...
                    <div class="col-md-12">
                      <div class="meet-inst">
                        ...
                        <div class="instructor">
                          <!-- <div class="inst-left">
                            <img src="images/instname.png" alt="">
                          </div> -->
                        ...
                        <div class="instructor">
                          ...
                          <div class="inst-right"><strong>accountantkay@yahoo.com</strong></div>
                        </div>
                      </div>
                    </div>
