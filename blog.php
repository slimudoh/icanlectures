    ...
    <div class="overlay">
        ...
        <div class="found-banner">
          <div class="container">
            <div class="row">
              <div class="col-md-2">
                <img src="images/found.png" alt="">
              </div>
              <div class="col-md-10">
                <h4 style="color:#fff">
                  <a href="index.php">HOME </a> <i class="fa fa-arrows-h"></i> BLOG
                </h4>
              </div>
            </div>
          </div>
          ...
          <div class="row">
                ...
                <a href="#">
                  <div class="resource">
                    <div class="res-banner">
                      <img src="images/quatech.png" alt="">
                    </div>
                    <div class="res-top">
                      <h3>Quantitative Techniques in Business</h3>
                    </div>
              ...
              <div class="col-md-2">
                <a href="#">
                  <div class="resource">
                    <div class="res-banner">
                      <img src="images/finacct.png" alt="">
                    </div>
                    <div class="res-top">
              ...
              <div class="col-md-2">
                <a href="#">
                  <div class="resource">
                    <div class="res-banner">
                      <img src="images/mgtinfo.png" alt="">
                    </div>
                    <div class="res-top">
