          ...
          <form>
            <div class="signin-inputdiv">
              ...
              <div class="inputdiv-right">
                <input type="text" class="login-input" placeholder="Firstname" name="" required>
              </div>
            </div>
            ...
            <div class="signin-inputdiv">
              ...
              <div class="inputdiv-right">
                <input type="text" class="login-input" placeholder="Lastname" name="" required>
              </div>
            </div>
            ...
            <div class="signin-inputdiv">
              ...
              <div class="inputdiv-right">
                <input type="password" class="login-input" placeholder="Confirm Password" name="" required>
              </div>
            </div>        

            <div class="signin-inputbtn">
              <input type="submit" name="" class="login-btn" value="REGISTER">
            </div>
          </form>          
        </div>
