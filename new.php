	...
	<div class="signin-div">
	  <div class="signin-box">
		...
		<div class="signin-key">
		  <img src="images/pwd.png" alt="padlock">          
		</div>
		...
		<div class="signin-input">
		  <form>
			...
			<div class="signin-inputdiv">
			  ...
			  <div class="inputdiv-right">
				<input type="password" class="login-input" placeholder="Enter new Password" name="" required>
			  </div>
			</div>
			...
			<div class="signin-inputdiv">
			  ...
			  <div class="inputdiv-right">
				<input type="password" class="login-input" placeholder="Confirm New Password" name="" required>
			  </div>
			</div>

			<div class="signin-inputbtn">
			  <input type="submit" name="" class="login-btn" value="RESET PASSWORD">
			</div>
		  </form>          
		</div>
